...
\[\left( \mathrm{Id} - C \right)\mathbf{v} = \mathbf{v} - C\mathbf{v} \approx (1 - \mu)\mathbf{v}.\]
...
\[\operatorname{Flatten}\left( \mathbf{x} \right) = \mathbf{x}',\] where
...
\[\operatorname{Flatten}\left( C_{1}C_{2} \right).\]
