...
\item
  ...
  \emph{discrete logarithm assumption} (Assumption \ref{tcb:ddh}),
...
\begin{theorem}{The group BN254 is isomorphic to ${\mathbb{Z}}/q{\mathbb{Z}}$}{}
...
Assumption \ref{tcb:ddh}. Curve25519 is defined as
