...
called Hasse\textquotesingle s theorem\footurl{https://en.wikipedia.org/wiki/Hasse\textquotesingle s\_theorem\_on\_elliptic\_curves}
...
multiple of a prime. The popular Curve25519\footurl{https://en.wikipedia.org/wiki/Curve25519}
...
EdDSA,\footurl{https://en.wikipedia.org/wiki/EdDSA} and it is used
