...
And these access patterns could reveal sensitive information.
...
\subsection{Naive solution 1}\label{naive-solution-1.}
...
\subsection{Naive solution 2}\label{naive-solution-2.}
...
\subsection{Naive solution 3}\label{naive-solution-3.}
...
accessed together). As mentioned earlier, one can leverage\footurl{https://www.ndss-symposium.org/wp-content/uploads/2017/09/06\_1.pdf}
