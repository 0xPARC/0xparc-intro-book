...
They can learn which addresses you access most frequently, which addresses you access at the same time.
And these access patterns could reveal sensitive information.

Oblivious RAM is a protocol that hides access patterns.
...
\footurl{https://eprint.iacr.org/2011/407.pdf}
