...
The \alert{Kate-Zaverucha-Goldberg (KZG)} commitment scheme is amazingly
...
\alert{root check} (not a standard name). Here is the problem statement:
...
\item
  ...
  $\Com(F)$ to $F$.\footnote{In fact, it is enough for
    ...
    Instead, in Step 5 below, Peggy opens $\Com(F_{1})$
